...
<li>Enter the text or URL for which you want to generate a QR code.<br>
<li>Click the "Generate" button to instantly generate the QR code.<br>
<li>The generated QR code will be displayed on the screen.
</ol>
